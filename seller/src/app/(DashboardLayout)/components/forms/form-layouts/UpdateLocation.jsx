...
import MapWithMarker from '@/app/(DashboardLayout)/map/Map';
...
function UpdateLocation({ showModal, setShowModal, setCoordinatesData }) {
  ...
  const [initialValues, setInitialValues] = useState({
    ...
    zipCode: '',
    landmark: '',
    addressType: { value: 'home', label: 'Home' },
  });
  ...
  return (
    <>
      <Dialog
        ...
        fullWidth
      >
        <DialogTitle variant="subTitle2">Update Your Work Location</DialogTitle>
              ...
              <Form className="" fullWidth>
                <div className="flex ">
                  <Grid container>
                    ...
                    <Grid container spacing={3}>
                      <Grid item xs={12} sm={11.3}>
                        <Box>
                          <CustomFormLabel htmlFor="checkBox">
                            <Box className="flex ">
                              <Checkbox
                                name="checkBox"
                                value={checked}
                              ...
                              <Typography variant="body1">
                                {<CustomStar />} This is your work location, from which you will
                                receive work within a 10km radius.
                              </Typography>
                            </Box>
                          </CustomFormLabel>
                          {!checked && (
                            ...
                            >
                              Please Check above checkbox to submit
                            </Typography>
                          )}
                        </Box>
                      </Grid>
