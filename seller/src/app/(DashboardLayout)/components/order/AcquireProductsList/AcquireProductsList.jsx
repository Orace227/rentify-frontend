...
const AcquireProductsList = () => {
  ...
  React.useEffect(() => {
    const fetchPendingOrders = () => {
      ...
      // dispatch(setPendingOrders(products)); // store products in to product variable and pass it in it to show
    };
    fetchPendingOrders();
  }, []);
...
export default AcquireProductsList;
